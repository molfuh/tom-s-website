...
export default function Footer() {
  return (
    <>
      ...
      <a href="https://www.facebook.com/tomslrmusic">
      ...
      <a href="https://www.linkedin.com/in/thomasravago/">
...
const Container = styled.div`
    ...
    #facebook-mask, #linkedin-icon, #instagram-mask {
      margin: 10px;
